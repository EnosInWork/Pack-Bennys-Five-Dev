...
config = {
    zone = {
        {"garage", vector3(1279.393, 2663.67, 36.65), "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage", function() OpendirGarageMenu() end, "s_m_y_airworker", 3.1009781360626, true},
    },
    garage = {
        vehs = {
            {label = "Renault DIR", veh = "utillitruck3"},
        },
        pos  = {
            {pos = vector3(1264.751, 2670.280, 37.60), heading = 338.55},     
        },
    },
}